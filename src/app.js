    ...
    switch (state.currentStep) {
        ...
        case 'MY_STORY': 
            ...
            html = GameView({ 
                ...
                content: culpritNotice + char.story, 
                story1: char.story_desc_1, story2: char.story_desc_2, 
                story3: char.story_desc_3, story4: char.story_desc_4, 
                buttonText: "자기소개로 넘어가기", nextStep: "TALK_0" 
            }); 
            break;
        ...
        case 'TALK_0': case 'TALK_1': case 'TALK_2': case 'TALK_3':
            ...
            html = GameView({ 
                title: tIdx === '0' ? '첫 대면 (자기소개)' : `${char.name} - ${tIdx}차 토론`, 
